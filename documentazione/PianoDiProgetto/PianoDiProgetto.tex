...
\begin{document}
	...
	Il piano di gestione dei rischi e? il punto di arrivo di un processo strutturato nelle seguenti attività:
	\begin{enumerate}
	...
	\subsection{Registro dei rischi}
		...
		{\renewcommand\arraystretch{1.2}
			\begin{tabular}{|c|c|c|c|c|c|}
				\hline 
				\textbf{Nome} & \textbf{Data} & \textbf{Occ.} & \textbf{Peric.} & \textbf{Prodotto} & \textbf{Trigger} \\ 
				\textbf{Ruolo} & \textbf{Owner} & \multicolumn{4}{|c|}{\textbf{Contromisure}} \\ 
				\hline 
				\multicolumn{6}{|c|}{\textbf{Livello Tecnologico}} \\ 
				\textit{RT1 - Tecnologie Adottate} & 12/12/2016 & Media & Alta & Medio-Alta & Errori di SO visualizzati \\ 
				Singolo & Responsabile & \multicolumn{4}{|c|}{\minitab[c]{Ciascun membro del team ha il \\dovere di informarsi con l'ausilio di documentazione anche fornita dal Responsabile}} \\ 
				\hline
				\textit{RT2 - Rottura Hardware} & 13/12/2016 & Bassa & Bassa & Bassa & --- \\ 
				Singolo & Singolo & \multicolumn{4}{|c|}{\minitab[c]{Si risolve utilizzando strumenti forniti dall'università in sostituzione a quelli personali}} \\ 
				\hline
				\hline 
				\multicolumn{6}{|c|}{\textbf{Livello Personale}} \\ 
				\textit{RP1 - Problemi dei singoli} & 27/01/2017 & Media & Media & Media & Previa comunicazione \\ Singolo & Responsabile & \multicolumn{4}{|c|}{\minitab[c]{Subito dopo la comunicazione sarà il \\Responsabile a rielaborare le mansioni e l'organizzazione del gruppo}}\\ 
				\hline
				\textit{RP2 - Problemi tra componenti} & 12/12/2016 & Bassa & Alta & Media & --- \\ \minitab[c]{Responsabile\\Singolo} & Responsabile & \multicolumn{4}{|c|}{\minitab[c]{Il Responsabile può ridistribuire \\i ruoli affinché non vi sia dipendenze tra i litiganti o dimettersi}} \\ 
				\hline
				\textit{RP3 - Inesperienza} & 12/12/2016 & Alta & Alta & Alta & --- \\ 
				Singolo & Singolo & \multicolumn{4}{|c|}{\minitab[c]{Impegno del singolo per informarsi e \\ aggiornarsi lasciando libertà di tempo aggiuntivo nel caso vi siano difficoltà}} \\ 
				\hline 
				\hline
				\multicolumn{6}{|c|}{\textbf{Livello organizzativo e valutazione dei costi}} \\ 
				\textit{RO1 - Valutazione Efficienza} & 16/12/2016 & Alta & Media & Medio-Alta & Sforo dell'attività rispettive nei diagrammi di pianificazione \\ \minitab[c]{Responsabile\\Analista\\Singolo} & Amministratore & \multicolumn{4}{|c|}{\minitab[c]{Riprogettazione immediata nel piano organizzativo e\\, se necessario, cambiamento delle priorità}} \\ 
				\hline
				\hline 
				\multicolumn{6}{|c|}{\textbf{Livello dei requisiti}} \\ 
				\textit{RR1 - Comprensione Requisiti} & 22/12/2016 & Media & Media & Medio & --- \\ \minitab[c]{Progettista\\Verificatore\\Singolo} &
				Analista & \multicolumn{4}{|c|}{Riunione e comunicazione tra le parti con correzioni al piano} \\ 
				\hline 
			\end{tabular} 
		}
		\normalsize
	...
	\subsection{Pianificazione dei rischi}
		...
		Il trasferimento del rischio implica il trasferimento della responsabilità di gestione attraverso la stipula, quando possibile, di un contratto d?assicurazione.\\
		...
		L?accettazione del rischio implica solo la definizione di un piano contingente di azione da intraprendere quando accade l?evento temuto. Il gruppo ha integrato la \textit{Pianificazione dei rischi} all'interno del \textit{Registro dei rischi}.
	%MODIFICHE DA FARE
	%Indicare i risti riscontrati e la date
	%Trasformare in numeri Occ. Ecc
	%Inserire Trasferire-Mitigare ecc
	...
	\begin{figure}[h]
		...
		\caption[Incremental Development]{Diagramma Sviluppo Incrementale}
	...
	\subsubsection{Tabella preventiva per periodo}
	\begin{center}
	{\renewcommand\arraystretch{1.2} %aumenta l'altezza di ogni riga
		\begin{tabular}{|c|c|c|}
			\hline 
