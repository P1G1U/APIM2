...
\end{itemize}
\subsubsection{Informativi}:	%DA COMPLETARE
\begin{itemize}
	\item 
\end{itemize} 
...
\subsubsection{Dominio applicativo} %PUNTI DA COMPLETARE
\begin{itemize}
...
\subsubsection{Potenziali rischi}
\begin{itemize}
	\item Alta criticità del progetto risiede nel fatto che il problema non è ancora stato risolto perciò potrebbe essere molto complesso consegnare il prodotto entro i tempi pattuiti;
