...
\end{itemize}
  ...
  \subsection{com.apim.server.controllers}{
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
          \includegraphics{\docsImg BEcontroller.png}
          \caption{Controller}
          \label{Controller}
        \end{figure}
  ...
  \subsection{com.apim.server.services}{
    \subsubsection{Informazioni sul Package}
     \begin{figure}[ht]
       \centering
       \includegraphics{\docsImg BEservices.png}
       \caption{Services}
       \label{Services}
     \end{figure}
  ...
  \subsection{com.apim.server.gateway}{
    \subsubsection{Informazioni sul Package}
      \begin{figure}[ht]
        \centering
        \includegraphics{\docsImg BEgateway.png}
        \caption{Testo figura}
        \label{Testo figura}
      \end{figure}
  ...
  \subsubsection{Informazioni sul Package}
    \begin{figure}[ht]
      \centering
      \includegraphics{\docsImg BEdataAnalysis.png}
      \caption{Testo figura}
      \label{Testo figura}
    \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
          \includegraphics{\docsImg BEkeyManager.png}
          \caption{Key Manager}
          \label{Key Manager}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht] 									
          \centering
          \includegraphics{\docsImg BEuser.png}
          \caption{User}
          \label{User}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
         \includegraphics{\docsImg BEadmin.png}
          \caption{Admin}
          \label{Admin}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
          \includegraphics{\docsImg BEshared.png}
          \caption{Shared}
          \label{Shared}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
         \includegraphics{\docsImg BEdao.png}
          \caption{DAO}
          \label{DAO}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
          \includegraphics{\docsImg BEentity.png}
          \caption{Entities}
          \label{Entities}
        \end{figure}
