...
\end{itemize}
  ...
  \subsection{com.apim.server}{
    \subsubsection{Informazioni sul Package}
     %   \begin{figure}[ht]
     %    \centering
     %     \includegraphics[width=\textwidth]{\docsImg figura.png}
  ...
  \subsection{com.apim.server.controllers}{
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
          \includegraphics[width=\textwidth]{\docsImg BEcontroller.png}
          \caption{Controller}
          \label{Controller}
        \end{figure}
  ...
  \subsection{com.apim.server.gateway}{
    \subsubsection{Informazioni sul Package}
      \begin{figure}[ht]
        \centering
        \includegraphics[width=\textwidth]{\docsImg BEgateway.png}
        \caption{Testo figura}
        \label{Testo figura}
      \end{figure}
  ...
  \subsubsection{Informazioni sul Package}
    \begin{figure}[ht]
      \centering
      \includegraphics[width=\textwidth]{\docsImg BEdataAnalysis.png}
      \caption{Testo figura}
      \label{Testo figura}
    \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
          \includegraphics[width=\textwidth]{\docsImg BEkeyManager.png}
          \caption{Key Manager}
          \label{Key Manager}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht] 									
          \centering
          \includegraphics[width=\textwidth]{\docsImg BEuser.png}
          \caption{User}
          \label{User}
        \end{figure}
    ...
    \subsubsection{Informazioni sul Package}
        \begin{figure}[ht]
          \centering
         \includegraphics[width=\textwidth]{\docsImg BEadmin.png}
          \caption{Admin}
          \label{Admin}
        \end{figure}
