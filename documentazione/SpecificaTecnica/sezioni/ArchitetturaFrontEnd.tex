\section{Architettura Front end}{
	\subsection{com.apim.client}{
		\subsubsection{Informazioni sul package}{
			\begin{figure}[ht]
				\centering
				\includegraphics[width=0.7\textwidth]{\docsImg feclient.png}
	...
	\subsection{com.apim.client.view}{
		\subsubsection{Informazioni sul package}{
			\begin{figure}[ht]
				\centering
				\includegraphics[width=0.7\textwidth]{\docsImg feview.png}
	...
	\subsection{com.apim.client.model}{
		\subsubsection{Informazione sul package}{
			\begin{figure}[ht]
				\centering
				\includegraphics[width=0.7\textwidth]{\docsImg femodel.png}
	...
	\subsection{com.apim.client.modelView}{
		\subsubsection{Informazione sul package}{
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.6\textwidth]{\docsImg femodelview.png}
