\section{Diagrammi di Attività}{
	...
	\subsection{Attività principali}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg AttivitaPrincipali.png}
	...
	\subsection{Autenticazione utente} {
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg Autenticazione}
	...
	\subsection{Recupero password}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg RecuperoPassword}
	...
	\subsection{Registrazione utente}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.8\textwidth]{\docsImg RegistrazioneUtente}
	...
	\subsection{Accesso pagina utente}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg AccessoPaginaUtente}
	...
	\subsection{Visualizza pagina utente}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg VisualizzaPaginaUtente}
	...
	\subsection{Modifica dati}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg ModificaDatiUtente}
	...
	\subsection{Registrazione nuova API}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.8\textwidth]{\docsImg RegistrazioneNuovaAPI}
	...
	\subsection{Visualizza API caricate}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg VisualizzaAPICaricate}
	...
	\subsection{Ricerca}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.8\textwidth]{\docsImg Ricerca}
	...
	\subsection{Visualizza pagina API}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{\docsImg VisualizzaPaginaAPI}
	...
	\subsection{Utente amministrativo}{
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.8\textwidth]{\docsImg UtenteAmministrativo}
