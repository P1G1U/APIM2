\section{Architettura Database}{
	...
	\subsubsection{Associazioni}
		\begin{itemize}
			\item\textit{Users-Acquisto}: molteplicita'n - 1. Un utente puo' acquistare uno o piu' microservizi, un microservizio puo' esser acquistata da uno o piu' utenti.
			\item\textbf{Users-API}: molteplicita' 1 - n. Un utente puo' mettere a disposizione uno o piu' microservizi, mentre un microservizio e' inserito nel database dal un solo utente.
			\item\textbf{Users-Commenti}: molteplicita' 1 - n. Un utente puo' lasciare diversi commenti in diverse API, mentre un commento e' lasciato per forza da un solo utente;
			...
			\item\textbf{Acquisto-Chiavi}: molteplicita' 1 - 1. Ogni acquisto avra' associata la propria chiave. 
			\item\textbf{API - Chiavi}: molteplicita' 1 - n. Una API avra' ad essa associate piu' chiavi, mentre una chiave appartiene ad una sola API.
			...
			\item\textbf{Users-Chiavi}: molteplicita' 1 -n. Un utente puo' possedere una o piu' chiavi, mentre una chiave sara' associata ad un solo utente.
		\end{itemize}				
