...
\begin{document}
	...
	{\renewcommand\arraystretch{1.2} %aumenta l'altezza di ogni riga
		...
		\begin{tabular}{|l|c|c|c|}
			...
			\hline 
			0.1.4 & \minitab[c]{Appendice A - MockUp} & Sebastiano Marchesini & 05/03/2017 \\
			\hline
			0.1.3 & \minitab[c]{Tracciamento} & Piergiorgio Danieli & 05/03/2017 \\
			\hline
			0.1.2 & \minitab[c]{Design Pattern - Utilizzo dei Design Pattern \\ Microservizi - Dependency Injection } & Piergiorgio Danieli & 04/03/2017 \\
			\hline
