...
\begin{document}
	...
	{\renewcommand\arraystretch{1.2} %aumenta l'altezza di ogni riga
		\begin{tabular}{|l|c|c|c|}
			...
			\hline
			0.0.14 & \minitab[c]{Design Pattern - Utilizzo dei Design Pattern\\Strutturali - Facade} & Piergiorgio Danieli & 28/02/2017 \\
			\hline
			...
			\hline
			0.0.8 & \mintab[c]{Database - Progettazione logica} & Piergiorgio Danieli & 22/02/2017 \\
			\hline
