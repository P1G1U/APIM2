...
Ogni componente del team è tenuto a leggere e seguire le norme qui contenute per ottimizzare il lavoro, uniformare tutti i documenti e minimizzare gli errori.\\
...
\begin{itemize}
	...
	\item \verb=\begin{tabular}{|c|c|c|} \end{tabular}= indica una tabella con 3 colonne e pos. testo centrale. La barra verticale ( | ) indica che vi è una linea divisoria verticale tra le celle;
...
Al momento non avendo prodotto software, e quindi impossibile eseguire dei test, si è scelto come regola generale una doppia revisione, anche a seconda del testo. Per doppia revisione si intende :
\begin{itemize}
...
È prediletto questa piattaforma per la sua versione sia web sia mobile. \\
...
È stata scelta tale applicazione perché compatibile con il sistema di ticketing offerto da \textit{Asana}. Infatti ogni attività e il suo responsabile è direttamente collegato al diagramma. \\
...
\begin{itemize}
	...
	\item Riceve e-mail automatiche con l'aggiornameto dei \textit{Task} che si seguono.
\end{itemize}
